...
public interface GatewayDeviceDetailsService extends BaseService<GatewayDeviceDetails> {

	/**
	 * 
	 * @Function: GatewayDeviceDetailsService.java
	 ...
	 */
	GatewayDeviceDetails findByDeviceMacAndToday(String deviceMac, String today);
	 ...
	 *        Administrator v1.0.0 修改原因
	 */
	List<ExcelExportGatewayDeviceVo> findLesstodayByToday(String today);
