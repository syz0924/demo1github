...
public class StrongCurrentController extends BaseController {
	...
	public JSONObject getIntelligentGatewayInfo(HttpServletRequest request, HttpSession session) {
		// 反馈
		...
		if (loginStatus) {
			...
			if (role.getRoleId() == 1 || role.getRoleId() == 2
				...
				for (IntelligentGateway intelligentGateway : intelligentGatewayList) {
					List<Relay> groupRelayIp = relayService
							.findGrouprs485toNetIpBygatewayMac(intelligentGateway.getMac());
	...
	public JSONObject getRelayInfoByGatewayMac(String gatewayMac, HttpServletRequest request, HttpSession session) {
		// 反馈
		JSONObject resultJson = new JSONObject();
		String result = "";
		// 登录状态
	...
	public JSONObject getRelayTaskDetailsInfo(Integer relayId, HttpServletRequest request, HttpSession session) {
		// 反馈
		JSONObject resultJson = new JSONObject();
		String result = "";
		// 登录状态
	...
	public JSONObject getRs485toNetIp(String gatewayMac, HttpServletRequest request, HttpSession session) {
		// 反馈
		JSONObject resultJson = new JSONObject();
		String result = "";
		// 登录状态
	...
	public JSONObject getSonRelayInfoByRs485toNetIp(String gatewayMac, String rs485toNetIp, HttpServletRequest request,
			HttpSession session) {
		// 反馈
		JSONObject resultJson = new JSONObject();
		String result = "";
	...
	public JSONObject findRealtimeTaskExitsByTaskName(String taskName, HttpServletRequest request,
			HttpSession session) {
		// 反馈
		JSONObject resultJson = new JSONObject();
		String result = "";
	...
	public JSONObject getRealtimeTaskAll(HttpServletRequest request, HttpSession session) {
		// 反馈
		JSONObject resultJson = new JSONObject();
		String result = "";
		// 登录状态
	...
	public JSONObject deleteRealtimeTask(Integer taskId, HttpServletRequest request, HttpSession session) {
		// 反馈
		JSONObject resultJson = new JSONObject();
		String result = "";
		// 登录状态
	...
	public JSONObject getGatewayTimedTaskAll(HttpServletRequest request, HttpSession session) {
		// 反馈
		JSONObject resultJson = new JSONObject();
		String result = "";
		// 登录状态
	...
	public JSONObject findGatewayTimedTaskExit(String taskName, HttpServletRequest request, HttpSession session) {
		// 反馈
		JSONObject resultJson = new JSONObject();
		String result = "";
		// 登录状态
	...
	public JSONObject editRealtimeTask(Integer taskId, HttpServletRequest request, HttpSession session) {
		// 反馈
		JSONObject resultJson = new JSONObject();
		String result = "";
		// 登录状态
	...
	public JSONObject updateRealtimeTask(RealtimeTasks realtimeTasks, HttpServletRequest request, HttpSession session) {
		// 反馈
		JSONObject resultJson = new JSONObject();
		String result = "";
		// 登录状态
	...
	public JSONObject sendAddRelayTimedTask(
			@RequestBody(required = false) RelayTimedTaskDataFormatVo relayTimedTaskDataFormat,
			...
			if (controlOnlineStatus) {
				...
				if (role.getRoleId() == 1 || role.getRoleId() == 2
					...
					if (timlyTasks != null) {
						...
						// 智能网关定时任务
						timedTasks = new TimedTasks(relayTimedTaskDataFormat.getTaskName(), taskMd5,
								taskMsg.getTaskMode(), Integer.parseInt(taskMsg.getDelaymsc()), null,
								taskMsg.getDayofweek(), JsonUtils.objectToJson(taskMsg.getTimlyTasks()),
								account.getProjectId(), DateUtils.fmtStrDateToTime(taskMsg.getStartTime()),
					...
					relayTimedTaskDataFormat.setProjectId(account.getProjectId());
					// json 数据
		...
		if (loginStatus) {
			...
			if (controlOnlineStatus) {
				...
				if (role.getRoleId() == 1 || role.getRoleId() == 2
					...
					relayRealTimeTaskDataFormat.setProjectId(account.getProjectId());
					// json 数据
				...
				if (role.getRoleId() == 1 || role.getRoleId() == 2
					...
					if (timedTasks.getRackIds() != null && timedTasks.getRackIds().length() > 0) {
						...
						Log log = new Log(account.getProjectId(), account.getAccountId(),
								EnumOperationMode.DELETE.name(), null, new Date(), new Date());
						webJsonData.put("log", log);
						webJsonData.put("timedTasks", timedTasks);
						webJsonData.put("projectId", account.getProjectId());
						// 添加ProjectAnalysisOpCodeThread对象的map中
