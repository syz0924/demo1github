...
public interface ProjectMapper extends BaseMapper<Project> {
	 ...
	 *        Administrator v1.0.0 修改原因
	 */
	List<AlarmDataVo> findSpriteNotExistDeleteTasksByParentId(@Param("projectId") Integer projectId);
	 ...
	 *        Administrator v1.0.0 修改原因
	 */
	List<Dmx512SensorAlarmInfoVo> findDMX512NotExistTemperatureAlarmByProjectId(@Param("projectId") Integer projectId);
	 ...
	 *        Administrator v1.0.0 修改原因
	 */
	List<Dmx512SensorAlarmInfoVo> findDMX512NotExistSmokeAlarmByProjectId(@Param("projectId") Integer projectId);
