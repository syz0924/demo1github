				...
				<div class="lovdmx-bodyinfo lovdmx-show">
					<div class="lovdmx-card lovdmxadmin-header">
						<div class="lovdmx-breadcrumb">
							<a>主页</a> <span>/</span> <a
								href="${path }/lovdmx/ht/uploadVideo/index.do"><cite>上传视频文件列表</cite></a>
						</div>
					</div>
					<div class="lovdmx-fluid">
						<div class="lovdmx-pd">
							<form class="lovdmx-form"
								action="${path }/lovdmx/ht/uploadVideo/index.do" method="GET">
								<div class="lovdmx-inline">
									...
									<div class="lovdmx-input-block">
										<div class="lovdmx-unselect lovdmx-form-select ">
											<c:choose>
												<c:when test="${empty uploadVideo.projectId }">
												...
												<c:otherwise>
													<div class="lovdmx-select-title">
														<input type="text"
															class="lovdmx-input lovdmx_unselect project_info"
															readonly value="${uploadVideo.projectName }"
															data-value="${uploadVideo.projectId }"
															placeholder="请选择项目" /><input type="hidden"
															class="lovdmx-input" value='${uploadVideo.projectId }'
															name="projectId" /><input type="hidden"
															class="lovdmx-input" value='${uploadVideo.projectName }'
															name="projectName" /> <span class="lovdmx-edge"></span>
													</div>
													<dl class="lovdmx-anim lovdmx-anim-upbit">
														<dd data-value="-1">请选择项目</dd>
														<c:forEach items="${projectList }" var="lst">
															<dd data-value="${lst.projectId }"
																class="${uploadVideo.projectId eq lst.projectId?'lovdmx-this':'' }">${lst.projectName }</dd>
														</c:forEach>
													</dl>
												</c:otherwise>
											</c:choose>
								...
								<div class="lovdmx-inline">
									...
									<div class="lovdmx-input-block">
										<div class="lovdmx-unselect lovdmx-form-select ">
											<c:choose>
												<c:when test="${empty uploadVideo.rtrLoaded }">
													<div class="lovdmx-select-title">
														<input type="text"
												...
												<c:otherwise>
													<div class="lovdmx-select-title">
														<input type="text"
															class="lovdmx-input lovdmx_unselect rtrLoaded_info"
															readonly value="${uploadVideo.rtrLoadedValue }"
															data-value="${uploadVideo.rtrLoaded }" placeholder="请选择" />
														<input type="hidden" class="lovdmx-input"
															value='${uploadVideo.rtrLoadedValue }'
															name="rtrLoadedValue" /> <input type="hidden"
															class="lovdmx-input" value='${uploadVideo.rtrLoaded }'
													...
													<dl class="lovdmx-anim lovdmx-anim-upbit">
														...
														<c:forEach items="${rtrLoadedList }" var="lst">
															<dd data-value="${lst.index }"
																class="${uploadVideo.rtrLoaded eq lst.index?'lovdmx-this':'' }">${lst.value }</dd>
														</c:forEach>
													</dl>
												</c:otherwise>
											</c:choose>
								...
								<div class="lovdmx-inline">
									...
									<div class="lovdmx-input-block">
										<div class="lovdmx-unselect lovdmx-form-select ">
											<c:choose>
												<c:when test="${empty uploadVideo.uploadRole }">
													<div class="lovdmx-select-title">
														<input type="text"
												...
												<c:otherwise>
													<div class="lovdmx-select-title">
														<input type="text"
															class="lovdmx-input lovdmx_unselect uploadRole_info"
															readonly value="${uploadVideo.uploadRoleValue }"
															data-value="${uploadVideo.uploadRole }" placeholder="请选择" />
														<input type="hidden" class="lovdmx-input"
															value='${uploadVideo.uploadRoleValue }'
													...
													<dl class="lovdmx-anim lovdmx-anim-upbit">
														...
														<c:forEach items="${uploadRoleList }" var="lst">
															<dd data-value="${lst.index }"
																class="${uploadVideo.uploadRole eq lst.index?'lovdmx-this':'' }">${lst.value }</dd>
														</c:forEach>
													</dl>
												</c:otherwise>
											</c:choose>
											...
											<c:choose>
												...
												<c:otherwise>
													<c:forEach items="${pageInfo.list }" var="list"
														varStatus="vs">
														<tr class="videoId${list.videoId }">
															<td class="table-checked lovdmx-unselect">
																<div class="lovdmx-table-cell lovdmxtable-cell-checkbox"
																	data-index="${list.videoId }">
																	<i
								...
								<div class="lovdmx-table-page">
									<div id="table-page">
										<div class="lovdmx-box lovdmx-page-default lovdmx-lovpage">
											...
											<c:if test="${!pageInfo.isFirstPage && pageInfo.size>0}">
												<a
													href="${path }/lovdmx/ht/uploadVideo/index.do?pageNo=${pageInfo.pageNum -1}&projectId=${uploadVideo.projectId}&projectName=${uploadVideo.projectName }&rtrLoaded=${param.rtrLoaded }&rtrLoadedValue=${param.rtrLoadedValue }&uploadRole=${param.uploadRole}&uploadRoleValue=${param.uploadRoleValue}"
											...
											<c:forEach begin="${pageInfo.firstPage }" var="pageNo2"
												...
												<a
													href="${path }/lovdmx/ht/uploadVideo/index.do?pageNo=${pageNo2}&projectId=${uploadVideo.projectId}&projectName=${uploadVideo.projectName }&rtrLoaded=${param.rtrLoaded }&rtrLoadedValue=${param.rtrLoadedValue }&uploadRole=${param.uploadRole}&uploadRoleValue=${param.uploadRoleValue}"
											...
											<input type='hidden' name="link"
												value='${path }/lovdmx/ht/uploadVideo/index.do?&projectId=${uploadVideo.projectId}&projectName=${uploadVideo.projectName }&rtrLoaded=${param.rtrLoaded }&rtrLoadedValue=${param.rtrLoadedValue }&uploadRole=${param.uploadRole}&uploadRoleValue=${param.uploadRoleValue}'>
